...
class Application extends \Pimple implements HttpKernelInterface, TerminableInterface {
	 ...
	 *
	 * @param mixed $callback
	 *        	Error handler callback, takes an Exception argument
	 * @param integer $priority
	 *        	The higher this value, the earlier an event
	 ...
	 * @param integer $flags
	 *        	The flags (@see htmlspecialchars)
	 * @param string $charset
	 *        	The charset
	 * @param Boolean $doubleEncode
	 *        	Whether to try to avoid double escaping or not
	 *        	
	 ...
	 * @param string $prefix
	 *        	The route prefix
	 * @param ControllerCollection|ControllerProviderInterface $controllers
	...
	/**
	 *
	 * @ERROR!!! If you call this method directly instead of run(), you must call the
