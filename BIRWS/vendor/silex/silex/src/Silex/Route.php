...
class Route extends BaseRoute {
	 ...
	 *        	A PHP callback that converts the original value
	 *        	
	 * @return Route $this The current Route instance
	 */
	 ...
	 *
	 * @param string $method
	 *        	The HTTP method name. Multiple methods can be supplied, delimited by a pipe character '|', eg. 'GET|POST'
	 *        	
	 * @return Route $this The current Route instance
	 */
	 ...
	 *
	 * @param string $host
	 *        	The host for which this route should be enabled
	 *        	
	 * @return Route $this The current Route instance
	 */
	 ...
	 *
	 * @param mixed $callback
	 *        	A PHP callback to be triggered when the Route is matched, just before the route callback
	 *        	
	 * @return Route $this The current Route instance
	 */
	 ...
	 *
	 * @param mixed $callback
	 *        	A PHP callback to be triggered after the route callback
	 *        	
	 * @return Route $this The current Route instance
	 */
