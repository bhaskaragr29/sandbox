...
class CurlHandleTest extends \Guzzle\Tests\GuzzleTestCase {
	...
	public function dataProvider() {
		...
		$tests = array (
				...
				array (
						'GET',
						'https://michael:123@localhost/index.html?q=2',
						null,
						null,
						array (
								CURLOPT_RETURNTRANSFER => 0,
				...
				array (
						'DELETE',
						'http://localhost:8124/delete.php',
						null,
						'body',
						array (
