...
class ErrorHandler {
	 ...
	 *
	 * @param integer $level
	 *        	The level at which the conversion to Exception is done (null to use the error_reporting() value and 0 to disable)
	 * @param Boolean $displayErrors
	 *        	Display errors (for dev environment) or just log them (production usage)
	 *        	
	 ...
	 *        	The channel associated with the logger (deprecation or emergency)
	 */
	...
	public function handle($level, $message, $file = 'unknown', $line = 0, $context = array()) {
		...
		if ($level & (E_USER_DEPRECATED | E_DEPRECATED)) {
			if (isset ( self::$loggers ['deprecation'] )) {
				...
				self::$loggers ['deprecation']->warning ( $message, array (
