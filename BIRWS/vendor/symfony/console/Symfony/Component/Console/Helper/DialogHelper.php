...
class DialogHelper extends InputAwareHelper {
	 ...
	 * @param Boolean|integer $attempts
	 ...
	 *        	
	 * @return integer string array value or values (the key of the choices array)
	 *        
	 ...
	 *
	 * @return string Boolean valid shell name, false in case no valid shell is found
	 */
